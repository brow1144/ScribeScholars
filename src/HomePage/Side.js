...
class Side extends Component {
  ...
  render() {
    ...
    if (this.props.page === "home" || this.props.page === "classes" || this.props.page === "liveFeed" || this.props.page === "createActivity" || this.props.page === "createGame" || this.props.page === "gradingPage" || this.props.page === "homeworks" || this.props.page === "inclass" || this.props.page === "studentLiveFeed" || this.props.page === "discussion" || this.props.page === "editActivity" || this.props.page === "studGame" || this.props.page === "teachGame") {
